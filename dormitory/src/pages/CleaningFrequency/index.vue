<template>
  <div class="all">
    ...
    <div v-if="switchs" class="footer">
      <h2>记录详情</h2>
      <div class="footer_2">
        <a-table :columns="columns4" :data-source="dataSource" :style="{ width: '100%' }" :pagination="false">
...
<script lang="ts" setup>
  ...
  import { floormanagement, dormitoryInfos, sweep } from '../../api/test/index';
  import { DataItem } from '@/layout/admin';
  import type { Dayjs } from 'dayjs';
  import { columns4 } from '@/layout/column';
  ...
  const getdata = () => {
    sweep(userId.value).then((res: any) => {
